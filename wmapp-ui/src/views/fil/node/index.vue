...
<!--      <el-table-column label=" ID" align="center" prop="id" />-->
      ...
      <el-table-column label="节点金额" align="center" prop="amount" />
      <el-table-column label="名额" align="center" prop="quota" />
      <el-table-column label="占用名额" align="center" prop="occupyQuota" />
...
<!--          >删除</el-button>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="节点金额" prop="amount">
          <el-input-number v-model="form.amount" controls-position="right" :min="0.00" :precision="2"/>
        </el-form-item>
        <el-form-item label="名额" prop="quota">
          <el-input-number :min="0" v-model="form.quota" placeholder="请输入名额" />
        </el-form-item>
...
<script>
import { listNode, getNode, delNode, addNode, updateNode, exportNode } from "@/api/fil/node";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        amount: [
          { required: true, message: "节点金额不能为空", trigger: "blur" }
        ],
        quota: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除节点编号为"' + ids + '"的数据项?', "警告", {
